    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/bann1.jpeg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/bann2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="img/bann3.jpg" class="d-block w-100" alt="...">
            </div>
    ...
    <div class="brand">
        <div class="container mt-4 h-100" >
            <div class="d-flex justify-content-center">
                <div class="d-block">
                    <h2 class="text-center">ช้อปตามแบรนดัง</h2>
                    <a href="brand/MSI.php" class="position-relative"><img src="img/brand/MSI.jpg" class="me-2" width="100px" height="100px" alt=""></a>
                    <a href="brand/ASUS.php" class="position-relative"><img src="img/brand/ASUS.jpg" class="me-2" width="100px" height="100px" alt=""></a>
                    <a href="brand/ACER.php" class="position-relative"><img src="img/brand/ACER.jpg" class="me-2" width="100px" height="100px" alt=""></a>
                    <a href="brand/DELL.php" class="position-relative"><img src="img/brand/DELL.jpg" class="me-2" width="100px" height="100px" alt=""></a>
                    <a href="brand/LENOVO.php" class="position-relative"><img src="img/brand/LENOVO.jpg" class="me-2" width="100px" height="100px" alt=""></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container mt-4" >
            <div class="d-flex justify-content-center">
                <div class="d-block ms-5">
                    <h2 class="text-start">สินค้าแนะนำ</h2>
                    <?php
                        $sql = "SELECT * FROM product WHERE p_id <= '8'";
                            ...
                            while($row = $result-> fetch_assoc()){
                                echo '<div class="card me-2 mb-2" style="width: 18rem;float: left;height: 29rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="card-title fs-5">'.$row["p_price"].'</span>
                                        <span class="card-title fs-6 text-decoration-line-through text-secondary">'.$row["p_tprice"].'<br></span>
                                        <a href="buypart.php?p_id='.$row["p_id"].'" class="btn btn-warning mt-1"><i class="bi bi-cart-plus">รายละเอียดสินค้า</i></a>
                                    </div>
                                </div>';
