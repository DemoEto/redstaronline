...
<body>
  <button id="btnScrollToTop"><i class="bi bi-arrow-up"></i></button>
  <!-- head -->
  <!-- navbar1 -->
  ...
  <!-- body -->
  <div class="search container" style="padding-left: 7%;">
    <div class="row ">
      <div class="col-4"><label>ค้นหาข้อมูล</label></div>
    </div>
    <form method="get" action="">
      <div class="row mb-2">
        ...
        <div class="col-4">
          ...
          <a href="computer.php" class="btn btn-secondary"><span>ล้างค้นหา</span></a>
        </div>
      </div>
      <div class="row">
        <div class="col-3">
          ...
          <label>ช่วงราคา </label><span id="price_show" class="ps-2">10000 - 200000</span>
        ...
        <div class="d-block ms-5">
          ...
          <?php
              if (isset($_POST['id']) && $_POST['id']){
                ...
                # code...
                $sql = "SELECT * FROM product WHERE p_type = 'คอมพิวเตอร์/โน๊ตบุ๊ค'";
              }
  ...
  <div class="container-fluid mt-4 " style="padding-left: 10%; padding-bottom: 50px;">
    ...
    <script>
      //? scolltop
        const btnScrollToTop = document.querySelector(" #btnScrollToTop"); btnScrollToTop.addEventListener("click",
      function(){ window.scrollTo(0, 0); }); //? price between $(document).ready(function(){ function filter_data(){
